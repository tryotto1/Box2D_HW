...
void Setup()
{
	...
	// 물 통 채우기
	{
		...
		boxbd_water.position.Set(2.3f, -3.5f);

		// step2
		b2Body* body_water = world->CreateBody(&boxbd_water);
		
		// step3
		water_shape.SetAsBox(12.4f, 0.5f);
